...
/* Nav */
.nav{height:52px;background:rgba(255,255,255,.96);backdrop-filter:blur(20px);border-bottom:1px solid rgba(0,0,0,.08);display:flex;align-items:center;padding:0 18px;gap:10px;flex-shrink:0;z-index:200}
      ...
      <>
        ...
        <div className="upload-pg">
          <nav className="nav">
            ...
            <Link href="/" style={{ fontSize:12, color:'rgba(0,0,0,.4)', textDecoration:'none', padding:'4px 10px', borderRadius:99 }}>← Tools</Link>
          </nav>
          <div className="uc">

...
/* ── Nav ── */
.nav{height:52px;background:rgba(255,255,255,.94);backdrop-filter:blur(24px);-webkit-backdrop-filter:blur(24px);border-bottom:1px solid rgba(0,0,0,.07);display:flex;align-items:center;padding:0 24px;gap:10px;position:sticky;top:0;z-index:100}
    ...
    <>
      ...
      <div className="pg">
        ...
        <nav className="nav">
          ...
          <span className="nav-tool">Word to PDF</span>

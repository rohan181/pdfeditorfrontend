...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://editpdfai.com/pdf-annotate' },
  robots: { index: true, follow: true },
  openGraph: {
    title: 'Annotate PDF Online Free — Highlight, Comment & Mark Up PDFs',
    description: 'Highlight, comment and draw on any PDF online for free. No signup, works in your browser.',
    type: 'website',
    url: 'https://editpdfai.com/pdf-annotate',
    siteName: 'EditPDF AI',
    images: [{ url: '/opengraph-image', width: 1200, height: 630, alt: 'Annotate PDF Online Free' }],
  },
  twitter: {

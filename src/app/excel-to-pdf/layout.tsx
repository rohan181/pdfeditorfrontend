...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://editpdfai.com/excel-to-pdf' },
  robots: { index: true, follow: true },
  openGraph: {
    title: 'Excel to PDF Converter Online Free — XLSX to PDF',
    description: 'Convert Excel XLSX and XLS files to PDF instantly. Preserves tables and formatting. Free, no signup.',
    type: 'website',
    url: 'https://editpdfai.com/excel-to-pdf',
    siteName: 'EditPDF AI',
    images: [{ url: '/opengraph-image', width: 1200, height: 630, alt: 'Excel to PDF Converter Online Free' }],
  },
  twitter: {

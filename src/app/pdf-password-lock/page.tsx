...
.pg{min-height:100vh;background:#fff;color:#1d1d1f;overflow-x:hidden}
          ...
          <div className="wrap nav-in">
            <Link href="/" className="logo">
              <div className="logo-mark">
                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#fff" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round"><path d="M6 22a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h8l6 6v12a2 2 0 0 1-2 2z"/><path d="M14 2v6h6"/></svg>
              </div>
              ...
              <>
                ...
                {!file ? (
                  ...
                  >
                    ...
                    <p>Drag & drop or click to browse<br/>Any PDF · Any size · Stays private</p>

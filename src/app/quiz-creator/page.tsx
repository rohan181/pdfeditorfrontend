      ...
      <nav style={S.nav}>
        <Link href="/" style={{ display:'inline-flex', alignItems:'center', gap:8, textDecoration:'none' }}>
          <div style={{ width:27, height:27, background:'#1d1d1f', borderRadius:7, display:'flex', alignItems:'center', justifyContent:'center' }}>
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none"><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z" fill="white"/><polyline points="14 2 14 8 20 8" stroke="#1d1d1f" strokeWidth="2"/></svg>
          </div>
          <span style={{ fontSize:14, fontWeight:700, color:'#1d1d1f', letterSpacing:'-.04em' }}>Edit<span style={{ color:'#7c3aed' }}>PDF</span> AI</span>
        </Link>

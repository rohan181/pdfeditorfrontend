  ...
  return <>
    ...
    <div className="metadata-page">
      ...
      <main className="metadata-main"><div className="metadata-wrap">
        ...
        <div className="metadata-info"><article><Fingerprint size={21} /><h3>Broad metadata cleanup</h3><p>Removes standard properties, XMP streams, document IDs, and page-level metadata references.</p></article><article><BadgeCheck size={21} /><h3>Preserves document quality</h3><p>Pages are not rasterized, so text, images, links, forms, bookmarks, and accessibility structure stay intact.</p></article><article><ShieldCheck size={21} /><h3>Private by design</h3><p>QPDF WebAssembly and the final verification both run locally. The PDF is never sent to a server.</p></article></div>

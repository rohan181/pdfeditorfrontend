...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://editpdfai.com/pdf-to-images' },
  robots: { index: true, follow: true },
  openGraph: {
    title: 'PDF to Image Converter Online Free — PDF to JPG, PNG',
    description: 'Convert PDF pages to high-quality JPG or PNG images. Free, instant, no signup needed.',
    type: 'website',
    url: 'https://editpdfai.com/pdf-to-images',
    siteName: 'EditPDF AI',
    images: [{ url: '/opengraph-image', width: 1200, height: 630, alt: 'PDF to Image Converter Online Free' }],
  },
  twitter: {

  ...
  return (
    <section className="site-cta-sec" style={{background:'linear-gradient(135deg, #2563EB 0%, #7C3AED 100%)'}}>
      ...
      <div style={{maxWidth:1200,margin:'0 auto'}}>
        <div style={{...MONO,fontSize:10,color:'rgba(255,255,255,.5)',letterSpacing:'0.14em',textTransform:'uppercase',marginBottom:24}}>
          Get started
        </div>
        <h2 style={{fontFamily:'var(--font-jakarta,system-ui)',fontSize:'clamp(44px,7vw,100px)',fontWeight:800,color:'#fff',letterSpacing:'-0.05em',lineHeight:.96,margin:'0 0 40px'}}>
        ...
        <div style={{display:'flex',alignItems:'center',gap:20,flexWrap:'wrap'}}>
          ...
          <span style={{...MONO,fontSize:11,color:'rgba(255,255,255,.55)',letterSpacing:'0.08em',textTransform:'uppercase'}}>
